    ...
    /// Shared helper that wraps an async operation inside a Combine publisher while
    /// preserving structured cancellation semantics.
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    enum CombineTaskPublisher {

        static func make<Output: Sendable>(
        ...
        private static func makeTaskPublisher<Output: Sendable>(
    ...
    /// Simple reference wrapper that lets us cancel the in-flight Task when the
    /// Combine subscription is cancelled.
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
