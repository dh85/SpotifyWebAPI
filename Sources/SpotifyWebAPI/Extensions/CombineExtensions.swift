import Foundation
  ...
  extension AlbumsService where Capability: PublicSpotifyCapability {
    ...
    public func severalPublisher(ids: Set<String>, market: String? = nil) -> AnyPublisher<
      [Album], Error
    > {
  ...
  extension AlbumsService where Capability == UserAuthCapability {
    ...
    public func savedPublisher(limit: Int = 20, offset: Int = 0) -> AnyPublisher<
      Page<SavedAlbum>, Error
    > {
  ...
  extension PlaylistsService where Capability == UserAuthCapability {
    ...
    public func myPlaylistsPublisher(limit: Int = 20, offset: Int = 0) -> AnyPublisher<
