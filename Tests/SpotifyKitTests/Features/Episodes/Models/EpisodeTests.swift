...
extension Episode {
  fileprivate static let fullExample = Episode(
    ...
    externalUrls: SpotifyExternalUrls(
      spotify: URL(string: "https://open.spotify.com/episode/episodeid")),
    href: URL(string: "https://api.spotify.com/v1/episodes/episodeid")!,
    id: "episodeid",
    images: [
      SpotifyImage(url: URL(string: "https://i.scdn.co/image/image1")!, height: 640, width: 640)
    ],
    ...
    show: SimplifiedShow(
      ...
      explicit: false,
      externalUrls: SpotifyExternalUrls(
        spotify: URL(string: "https://open.spotify.com/show/showid")),
